...
//
// Solidity: function createCampaign(uint256 targetAmount, uint256 duration, uint256 startTimestamp, uint256 templateId, string campaignName) returns(uint256 campaignId, address campaign)
