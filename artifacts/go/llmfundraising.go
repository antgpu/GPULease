...
// CampaignURI is a free data retrieval call binding the contract method 0xdb912e37.
//
// Solidity: function campaignURI() view returns(string)
func (_LLMFundraising *LLMFundraisingCaller) CampaignURI(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _LLMFundraising.contract.Call(opts, &out, "campaignURI")
...
//
// Solidity: function campaignURI() view returns(string)
func (_LLMFundraising *LLMFundraisingSession) CampaignURI() (string, error) {
	return _LLMFundraising.Contract.CampaignURI(&_LLMFundraising.CallOpts)
}

// CampaignURI is a free data retrieval call binding the contract method 0xdb912e37.
//
// Solidity: function campaignURI() view returns(string)
func (_LLMFundraising *LLMFundraisingCallerSession) CampaignURI() (string, error) {
	return _LLMFundraising.Contract.CampaignURI(&_LLMFundraising.CallOpts)
}
